...
struct ContentView: View {
    ...
    var body: some View {
         ...
         .padding() .overlay(RoundedRectangle(cornerRadius: 8).stroke(Color.gray, lineWidth: 1)) .padding(.horizontal)
         HStack {
         ...
         HStack {
             ...
             .keyboardType(.asciiCapable) } .padding() .overlay(RoundedRectangle(cornerRadius: 8).stroke(Color.gray, lineWidth: 1)) .padding(.horizontal)
         HStack {
